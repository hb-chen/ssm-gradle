package com.hobo.app.mahout.recommendation.job;
...
public final class RecommendFactory {
    ...
    public static DataModel buildDataModel(String file) throws TasteException, IOException {
        return new FileDataModel(ResourceUtils.getFile(file));
    }

    public static DataModel buildDataModelNoPref(String file) throws TasteException, IOException {
        return new GenericBooleanPrefDataModel(GenericBooleanPrefDataModel.toDataMap(new FileDataModel(ResourceUtils.getFile(file))));
    }
